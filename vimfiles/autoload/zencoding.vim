...
\            'input:h': [{'class': 'inp-h'}, {'type': 'hidden'}],
\            'input:text': [{'type': 'text'}],
\            'input:t': [{'class': 'inp-t'}, {'type': 'text'}],
\            'input:search': [{'type': 'search'}],
\            'input:email': [{'type': 'email'}],
\            'input:url': [{'type': 'url'}],
\            'input:password': [{'type': 'password'}],
\            'input:p': [{'class': 'inp-p'}, {'type': 'password'}],
\            'input:datetime': [{'type': 'datetime'}],
\            'input:date': [{'type': 'date'}],
\            'input:datetime-local': [{'type': 'datetime-local'}],
\            'input:month': [{'type': 'month'}],
\            'input:week': [{'type': 'week'}],
\            'input:time': [{'type': 'time'}],
\            'input:number': [{'type': 'number'}],
\            'input:color': [{'type': 'color'}],
\            'input:checkbox': [{'type': 'checkbox'}],
\            'input:c': [{'class': 'inp-c'}, {'type': 'checkbox'}],
\            'input:radio': [{'type': 'radio'}],
\            'input:r': [{'class': 'inp-r'}, {'type': 'radio'}],
\            'input:range': [{'type': 'range'}],
\            'input:file': [{'type': 'file'}],
\            'input:f': [{'class': 'inp-f'}, {'type': 'file'}],
\            'input:submit': [{'type': 'submit'}, {'value': ''}],
\            'input:s': [{'class': 'inp-s'}, {'type': 'submit'}, {'value': ''}],
\            'input:image': [{'type': 'image'}, {'src': ''}, {'alt': ''}],
\            'input:i': [{'class': 'inp-i'}, {'type': 'image'}, {'src': ''}, {'alt': ''}],
\            'input:reset': [{'type': 'reset'}, {'value': ''}],
\            'input:button': [{'type': 'button'}, {'value': ''}],
\            'input:b': [{'class': 'inp-b'}, {'type': 'button'}, {'value': ''}],
\            'select': [{'class': 'select'}],
\            'option': {'value': ''},
...
\            'map': 'map>area',
\            'table': 'table>tr>td',
\            't': 'table>((colgroup>col[width=""])+(thead>tr>th)+(tbody>tr>td)',
